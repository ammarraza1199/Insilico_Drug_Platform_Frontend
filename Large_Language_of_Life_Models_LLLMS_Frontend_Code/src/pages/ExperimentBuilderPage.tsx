...
const ExperimentBuilderPage: React.FC = () => {
  ...
  const systems = [
    ...
    {
      id: 'p3',
      name: 'Multispecies & Tissue Engine',
  ...
  return (
    <div className="space-y-12 py-8 max-w-5xl mx-auto">
      <div className="text-center">
        ...
        <p className="mt-2 text-slate-500">Select one of the Large Language of Life Models (LLLMS) AI systems to begin your in-silico simulation.</p>
      </div>
