...
const AppSidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: 'LifespanAI', icon: TestTube2, path: '/experiment/p1/new' },
    { name: 'Clinomics Engine', icon: Database, path: '/experiment/p2/new' },
    { name: 'Multispecies & Tissue Engine', icon: Cpu, path: '/experiment/p3/new' },
      ...
      <aside className={cn(
        ...
        <div className="flex h-16 items-center justify-between px-4">
          {(!isSidebarCollapsed || isMobileMenuOpen) && (
            <div className="text-xl font-bold text-scientific-blue">Large Language of Life Models (LLLMS)</div>
          )}
          <button
