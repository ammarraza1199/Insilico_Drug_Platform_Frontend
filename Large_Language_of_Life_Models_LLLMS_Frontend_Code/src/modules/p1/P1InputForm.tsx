      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <section className="space-y-4">
          ...
          <div>
            ...
            <input 
              ...
              defaultValue="My New Experiment"
            />
        ...
        <section className="space-y-4">
          ...
          <FileUploadZone 
            ...
            onFileSelect={(file) => setValue('methylationFileId', file ? 'mock-id' : '', { shouldValidate: true })} 
            helperText="Upload CpG site methylation values"
          />
          {errors.methylationFileId && <p className="mt-1 text-xs text-scientific-red font-bold">{errors.methylationFileId.message}</p>}
          <FileUploadZone 
            label="RNA-seq Gene Expression (Optional)" 
            onFileSelect={(file) => setValue('rnaSeqFileId', file ? 'mock-id' : '', { shouldValidate: true })} 
          />
        </section>
