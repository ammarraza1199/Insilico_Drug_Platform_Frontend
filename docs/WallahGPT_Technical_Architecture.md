# WallahGPT — Technical Architecture Document
...
WallahGPT is a full-stack, AI-powered computational biology platform built on a **decoupled microservice-style architecture**. It comprises:
...
The three core AI modules (WallahGPT1, WallahGPT2, WallahGPT3) are independently routed but share the same LLM client infrastructure, prompt engine, simulation fallback layer, and experiment logging service.
...
### 4.1 WallahGPT1 — Full Experiment Flow
...
### 6.4 WallahGPT1 (Biological Aging)
...
### 6.5 WallahGPT2 (Synthetic Omics)
...
graph TD
    ...
    LAND["LandingPage"]
    P1PAGE["P1Page (WallahGPT1)"]
    P2PAGE["P2Page (WallahGPT2)"]
    P3PAGE["P3Page (WallahGPT3)"]
    DASH["DashboardPage"]
    PROJ["ProjectsPage"]
...
*End of Technical Architecture Document — WallahGPT v1.0*
