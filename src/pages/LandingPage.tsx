...
import { Zap, Database, BarChart3, ArrowRight } from 'lucide-react';
      ...
      <section className="bg-slate-900 py-24 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-400">
            PreciousGPT leverages multi-omics AI models to replace wet laboratory experimentation with digital simulation — reducing time, cost, and ethical constraints.
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              {
                title: 'Precious1GPT',
                desc: 'Biological Aging Clock. Predict biological age from molecular data with clinical precision.',
                icon: Zap,
                color: 'text-scientific-blue'
              },
              {
                title: 'Precious2GPT',
                desc: 'Synthetic Multi-Omics Data Generator. Create valid artificial datasets for any tissue or age.',
                icon: Database,
                color: 'text-scientific-teal'
              },
              {
                title: 'Precious3GPT',
                desc: 'Digital Drug Discovery Engine. Simulate drug perturbation experiments in silico.',
                icon: BarChart3,
                color: 'text-scientific-purple'
              }
            ].map((feature, i) => (
      ...
      <section className="bg-slate-50 py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="rounded-3xl bg-scientific-blue p-12 text-white shadow-xl">
            ...
            <p className="mt-4 text-blue-100">Join leading institutions using PreciousGPT for computational biology.</p>
            <Link 
              to="/register" 
