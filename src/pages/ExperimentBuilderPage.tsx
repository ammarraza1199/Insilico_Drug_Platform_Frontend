...
import { Zap, Database, BarChart3, ChevronRight, FlaskConical } from 'lucide-react';
  ...
  return (
    <div className="space-y-12 py-8 max-w-5xl mx-auto">
      <div className="text-center">
        ...
        <p className="mt-2 text-slate-500">Select one of the PreciousGPT AI systems to begin your in-silico simulation.</p>
      </div>
