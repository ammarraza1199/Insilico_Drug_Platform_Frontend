...
const AppSidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: 'WallahGPT1', icon: TestTube2, path: '/experiment/p1/new' },
    { name: 'WallahGPT2', icon: Database, path: '/experiment/p2/new' },
    { name: 'WallahGPT3', icon: Cpu, path: '/experiment/p3/new' },
    ...
    <>
      ...
      <div className="flex h-16 items-center justify-between px-4">
        {(!isSidebarCollapsed || isMobileMenuOpen) && (
          <div className="text-xl font-bold text-scientific-blue">WallahGPT</div>
        )}
        <button 
